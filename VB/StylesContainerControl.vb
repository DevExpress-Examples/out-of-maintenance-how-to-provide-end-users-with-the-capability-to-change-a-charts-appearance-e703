...
Namespace DevExpress.XtraCharts.Design
	...
	Public Class StylesContainerControl
		...
		Private Class AppearanceColors
			Private appearance_Renamed As ChartAppearance
			Private palette As Palette
			Private editors() As StyleEdit
			Public ReadOnly Property Appearance() As ChartAppearance
				Get
			...
			Default Public Property Item(ByVal index As Integer) As StyleEdit
				...
				End Set
			End Property
			Public Sub New(ByVal appearance As ChartAppearance, ByVal palette As Palette)
		...
		Public ReadOnly Property CurrentAppearance() As ChartAppearance
			Get
		...
		Public Sub Initialize(ByVal chart As ChartControl)
			Me.chart = chart
			UpdateIt()
		...
		Public Sub UpdateIt()
			...
			Try
				...
				For Each appearance As ChartAppearance In chart.AppearanceRepository
					Dim currentPalette As Palette = chart.PaletteRepository(chart.PaletteName)
					If (Not currentPalette.Predefined) OrElse appearance Is chart.AppearanceRepository(chart.AppearanceName) OrElse String.IsNullOrEmpty(appearance.PaletteName) OrElse appearance.PaletteName = currentPalette.Name Then
						RegisterAppearance(appearance, ViewType.Bar, currentPalette)
					End If
				Next appearance
			Finally
				ResumeLayout()
		...
		End Sub
		Public Sub SelectStyle(ByVal appearance As ChartAppearance, ByVal paletteIndex As Integer)
			...
			current = Point.Empty
		End Sub
		Public Sub RegisterAppearance(ByVal appearance As ChartAppearance, ByVal viewType As ViewType, ByVal palette As Palette)
		...
		Private Sub EditValueChanged()
			Dim paletteName As String = chart.PaletteName
