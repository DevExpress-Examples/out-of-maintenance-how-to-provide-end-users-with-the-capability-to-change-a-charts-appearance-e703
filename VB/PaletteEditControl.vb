...
Namespace ChartAppearanceSample
	Partial Public Class PaletteEditControl
		...
		Private chart_Renamed As ChartControl
		...
		Public Property Chart() As ChartControl
			...
			Set(ByVal value As ChartControl)
				...
				SelectedPalette = chart_Renamed.PaletteRepository(chart_Renamed.PaletteName)
			End Set
		End Property
		<DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden)> _
		...
		Private Sub lbPalettes_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles lbPalettes.SelectedIndexChanged
			If chart_Renamed IsNot Nothing Then
				chart_Renamed.PaletteName = SelectedPalette.Name
			End If
			RaisePaletteChanged()
		End Sub
